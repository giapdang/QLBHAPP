        ...
        btnDoiMatKhau.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (newPass.equals(confirmPass)) {
                    ...
                    Toast.makeText(CaiDatDoiMatKhauActivity.this, "Mật khẩu mới không khớp", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        userApi.doiMatKhau(request).enqueue(new Callback<Void>() {
            ...
            public void onResponse(Call<Void> call, Response<Void> response) {
                if (response.isSuccessful()) {
                    Toast.makeText(CaiDatDoiMatKhauActivity.this, "Đổi mật khẩu thành công", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CaiDatDoiMatKhauActivity.this, CaiDatActivity.class);
                    startActivity(intent);
                    finish();
                } else {
                    Toast.makeText(CaiDatDoiMatKhauActivity.this, "Đổi mật khẩu thất bại", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onFailure(Call<Void> call, Throwable t) {
                Toast.makeText(CaiDatDoiMatKhauActivity.this, "Lỗi: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}